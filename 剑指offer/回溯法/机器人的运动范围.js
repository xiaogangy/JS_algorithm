 ...
 *
 * 思路：这道题也是一道回溯的经典例题。为什么可以用是回溯呢？机器人可以从一个格子出发，如果当前这个这个可以访问，就去访问它的相邻格子(上下左右)，如果某个格子不能访问，就访问父格子，
 * 访问它的另外一个子格子；如果某个相邻格子可以访问的话，那么就可以把这个格子作为一个新的起点，继续去访问它的相邻格子。这样的话，其实就是一直在解决同样的问题，只不过是问题规模发生了变化。
 * 所以这道题，可以用递归来解决。
 */
