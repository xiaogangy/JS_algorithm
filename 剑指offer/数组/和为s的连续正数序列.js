 ...
 * - 当左 + 右 = s，确定了一组序列，保存起来。此时，让左指针右移一位，开始寻找新的序列；
 * - 继续进行如上循环，什么时候终止呢？因为题目要求至少有两个数，所以我们要保证左指针小于 (s + 1) / 2 ，例如题目中的例子，(15+1)/2 = 8，左指针要小于8
 *
 * solution2: 数学规律
 ...
 * - n从2开始取值，一直取值到t
 * - 针对某个个数m，我们知道可以带入公式求出start和end的值，自然就可以判断区间
 */
