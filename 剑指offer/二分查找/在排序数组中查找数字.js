 ...
 *
 * solution2: 普通二分查找
 * 看到有序数组找数，一定要第一反应就是二分查找。这道题如果用一般的二分查找思路，会是找到等于k的元素，然后分别向前和向后遍历，找到这个元素的首尾位置，就能统计出来这个
 ...
 * 以找第一个为值等于k的元素为例，我们还是用二分查找。我们还是用老套的二分查找套路来找到值等于k的元素，这时候要注意了。我们需要判断一下这个元素左边是不是等于k，如果等于k，
